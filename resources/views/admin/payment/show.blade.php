    ...
    <div class="container">
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                {!! Breadcrumbs::render('admin.payment.show', $pagamento) !!}
                @if(isset($message))
                    <div class="row">
                        <div class="col-sm-12">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <a href="{{route('admin.account.show',[$pagamento->conta->user->id, $pagamento->conta->idConta])}}" class="btn btn-sm btn-primary">Continuar</a>
                    </div>
                </div>
            </div>
        </div>
